...
<%
	...
	/* for(String ranger : (List<Stirng> request.getAttribute("rangers"))){
		출력
	}
...
%>
<c:forEach var="ranger" items="${rangers} " varStatus="loop">
	<li>${ranger}</li>
</c:forEach>
...
<%
	...
	//for(String str : list) ==> list에 담겨있는 모든 값에 대해 처리
